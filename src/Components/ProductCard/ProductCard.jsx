...
const ProductCard = ({ item,handleDelete }) => {
    ...
    const { productName, productPrice, _id } = item;
    ...
    return (
        <div>
            ...
            <div className="w-full max-w-xl bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                <a href="#">
                    <img className="p-0 rounded-t-lg" src={productName} alt="product image" />
                </a>
                <div className="px-5 pb-5">
                    ...
                    <div className="flex items-center justify-between">
                        ...
                        <button onClick={() => handleDelete(_id)} type="submit" className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">delete</button>
